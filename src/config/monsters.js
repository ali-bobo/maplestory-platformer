// 怪物定義 v5.3 — 補齊後段大怪正常體型，並為部分怪加入低頻跳躍壓迫感
...
export const MONSTERS = [
  ...
  // ── 古代廢墟 (ruins) Lv9-18 ──────────────────────────────────────────────
  { id: 'boar',     name: '飛天惡豬',   level: 9,  hp: 380,  atk: 48,  exp: 90,  speed: 90,  meso: 22, dropRate: 0.15, behavior: 'chase',   spriteKey: 'monster_boar',     area: 'ruins',   visualScale: 1.1, jumpProfile: { minInterval: 3400, maxInterval: 5200, velocity: 320, chance: 0.38 } },
  ...
  { id: 'ruin_golem',  name: '石柱魔像', level: 13, hp: 520, atk: 65,  exp: 135, speed: 50,  meso: 32, dropRate: 0.17, behavior: 'patrol',  spriteKey: 'monster_new_4',    area: 'ruins',   visualScale: 1.14 },
  ...
  { id: 'ruin_beast',  name: '廢墟猛獸', level: 12, hp: 480, atk: 60,  exp: 120, speed: 95,  meso: 30, dropRate: 0.16, behavior: 'chase',   spriteKey: 'monster_big_0',    area: 'ruins',   visualScale: 1.22, jumpProfile: { minInterval: 2600, maxInterval: 4200, velocity: 360, chance: 0.42 } },
  { id: 'ruin_giant',  name: '廢墟巨人', level: 15, hp: 700, atk: 78,  exp: 160, speed: 55,  meso: 36, dropRate: 0.18, behavior: 'patrol',  spriteKey: 'monster_big_1',    area: 'ruins',   visualScale: 1.32 },

  // ── Kerning City (kerning) Lv19-28 ────────────────────────────────────────
  { id: 'dragon',   name: '小藍龍',     level: 19, hp: 900,  atk: 105, exp: 260, speed: 85,  meso: 52, dropRate: 0.22, behavior: 'chase',   spriteKey: 'monster_dragon',   area: 'kerning', visualScale: 1.1 },
  { id: 'cyclops',  name: '獨眼怪',     level: 22, hp: 1100, atk: 125, exp: 330, speed: 70,  meso: 60, dropRate: 0.24, behavior: 'patrol',  spriteKey: 'monster_cyclops',  area: 'kerning', visualScale: 1.16 },
  { id: 'golem',    name: '石頭精',     level: 25, hp: 1400, atk: 145, exp: 420, speed: 45,  meso: 70, dropRate: 0.26, behavior: 'patrol',  spriteKey: 'monster_golem',    area: 'kerning', visualScale: 1.2 },
  ...
  { id: 'city_mech',   name: '機械衛士', level: 23, hp: 1200,atk: 130, exp: 350, speed: 75,  meso: 62, dropRate: 0.24, behavior: 'ranged',  spriteKey: 'monster_big_2',    area: 'taipei',  visualScale: 1.18 },
  { id: 'city_beast',  name: '暗夜猛獸', level: 26, hp: 1500,atk: 150, exp: 440, speed: 80,  meso: 72, dropRate: 0.26, behavior: 'chase',   spriteKey: 'monster_big_3',    area: 'kerning', visualScale: 1.26, jumpProfile: { minInterval: 2400, maxInterval: 3800, velocity: 390, chance: 0.44 } },
  ...
  { id: 'city_elite',  name: '精英衛兵', level: 24, hp: 1300,atk: 140, exp: 380, speed: 70,  meso: 66, dropRate: 0.25, behavior: 'patrol',  spriteKey: 'monster_big_4',    area: 'taipei',  visualScale: 1.18, jumpProfile: { minInterval: 3600, maxInterval: 5400, velocity: 310, chance: 0.3 } },
