...
楓之谷風格的 2D 橫向捲軸平台動作遊戲。扮演盜賊，從浮空島嶼出發，穿越森林、峽谷、神秘之境、台北都會與 Kerning City，最終挑戰暗影魔君。
...
### 古代廢墟
- **背景**：沙漠廢墟，石拱遺跡
- **怪物**：以骷髏戰士、廢墟騎士為主，搭配少量魔像與巨人（Lv9–18）
- **推薦等級**：Lv9–20

### 神秘之境
- **背景**：彩色奇幻城區，作為城市區前的過渡地帶
- **怪物**：精靈、飛行與奇幻怪物為主，如雲端精靈、浮雲鳥、擬態箱
- **推薦等級**：Lv13–22
...
> 目前怪物配置採 **主題式精選**：不是每一張已接入的怪物圖都會同時上場，優先維持版面和諧、乾淨與地圖辨識度。
...
### 目前狀態
- 已完成：主線戰鬥流程、Boss 進入與結算、裝備掉落、技能冷卻 HUD、HP/MP 自動回復、WebGL/rexUI 基礎層、Taipei 支線地圖、主題式怪物分流、小王放大出場
- 待補強：ESC 暫停選單、目標選取框、Level Up 全屏演出、Boss 第三階段視覺、城鎮商店正式接入、更多城市專屬平台美術
